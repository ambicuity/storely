...
/**
 * Will create a Storely instance with the BigMap adapter.
 * @param {BigMapOptions} options - Options for the BigMap adapter such as storeSize and storeHashFunction.
 * @returns {Storely} - Storely instance with the BigMap adapter
 */
export function createStorely<K = string, V = unknown>(options?: BigMapOptions): Storely {
