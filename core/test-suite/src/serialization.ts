import Storely, { type StorelySerializationAdapter } from "@ambicuity/ambicore";
 ...
 * Also tests integration with a Storely instance.
 * @param test - The test registration function (e.g. vitest `it`)
 * @param serialization - The serialization adapter instance to test
 */
const serializationTestSuite = (test: TestFunction, serialization: StorelySerializationAdapter) => {
	...
	test("stringify/parse with main storely", async (t) => {
