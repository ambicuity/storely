...
import {
	...
	RedisErrorMessages,
	type StorelyRedisEntry,
	type StorelyRedisOptions,
	type StorelyRedisPropertyOptions,
} from "./types.js";
...
export default class StorelyRedis<T> extends Hookified implements StorelyStorageAdapter {
	...
	private setOptions(options?: StorelyRedisOptions): void {
		if (!options) {
			return;
		}
