 ...
 *
 * Usage:
 *   npx tsx scripts/migrate-v6.ts --uri mysql://user:pass@localhost:3306/db [--table storely] [--keyLength 255] [--namespaceLength 255] [--dry-run]
 */
...
function parseArgs(args: string[]): {
	...
	if (!uri) {
		...
		console.error(
			"Usage: npx tsx scripts/migrate-v6.ts --uri mysql://user:pass@localhost:3306/db [--table storely] [--keyLength 255] [--namespaceLength 255] [--dry-run]",
		);
		process.exit(1);
	}
