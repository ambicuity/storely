 ...
 *
 * Usage:
 *   npx tsx scripts/migrate-v6.ts --uri postgresql://user:pass@host:5432/db [--table storely] [--schema public] [--keyLength 255] [--namespaceLength 255] [--dry-run]
 */
...
function parseArgs(args: string[]): {
	...
	if (!uri) {
		...
		console.error(
			"Usage: npx tsx scripts/migrate-v6.ts --uri postgresql://user:pass@host:5432/db [--table storely] [--schema public] [--keyLength 255] [--namespaceLength 255] [--dry-run]",
		);
		process.exit(1);
	}
