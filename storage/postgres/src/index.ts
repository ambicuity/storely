...
import Storely, { type StorelyEntry, type StorelyStorageAdapter } from "@ambicuity/storely-core";
 ...
 */
export class StorelyPostgres extends Hookified implements StorelyStorageAdapter {
	...
	/**
	 * Creates a new StorelyPostgres instance.
	 * @param options - A PostgreSQL connection URI string or a {@link StorelyPostgresOptions} configuration object.
	 */
	constructor(options?: StorelyPostgresOptions | string) {
	...
	private setOptions(options: StorelyPostgresOptions): void {
...
/**
 * Helper function to create a Storely instance with StorelyPostgres as the storage adapter.
 * @param options - Optional {@link StorelyPostgresOptions} configuration object.
 * @returns A new Storely instance backed by PostgreSQL.
 */
export const createStorely = (options?: StorelyPostgresOptions) =>
