...
import StorelySqlite, { createSqlite3Driver } from "../src/index.js";
import { handleOutput } from "./utils.js";

const bench = new Bench({ name: "node, better & sqlite3", iterations: 10_000 });
const storeNode = new StorelySqlite({ uri: "sqlite://:memory:", driver: "node:sqlite" });
const storeBetter = new StorelySqlite({ uri: "sqlite://:memory:", driver: "better-sqlite3" });
const storeSqlite3 = new StorelySqlite({
	uri: "sqlite://:memory:",
