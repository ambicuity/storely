...
section: "Core"
order: 2
description: "Core API reference for Storely."
---
...
```ts
import { Storely, StorelyJsonSerializer } from "@ambicuity/storely-core";
...
```js
import Storely, { StorelyHooks } from '@ambicuity/storely-core';
```
...
Returns a `StorelyCapability` with a boolean for each Storely method/property. The `@ambicuity/storely-core` flag is `true` only when **all** capabilities are present.

```ts
import Storely, { detectStorely } from '@ambicuity/storely-core';
...
```ts
import { detectStorelyStorage } from '@ambicuity/storely-core';
...
```ts
import { detectStorelyCompression } from '@ambicuity/storely-core';
...
```ts
import { detectStorelySerialization } from '@ambicuity/storely-core';
...
```ts
import { detectStorelyEncryption } from '@ambicuity/storely-core';
...
```ts
import { detectCapabilities } from '@ambicuity/storely-core';
...
```js
import { StorelyStats } from '@ambicuity/storely-core';
