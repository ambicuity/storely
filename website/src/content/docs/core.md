...
```ts
import { Storely, StorelyJsonSerializer } from "@ambicuity/core";
...
```js
import Storely, { StorelyHooks } from '@ambicuity/core';
```
...
Returns a `StorelyCapability` with a boolean for each Storely method/property. The `@ambicuity/core` flag is `true` only when **all** capabilities are present.

```ts
import Storely, { detectStorely } from '@ambicuity/core';
...
```ts
import { detectStorelyStorage } from '@ambicuity/core';
...
```ts
import { detectStorelyCompression } from '@ambicuity/core';
...
```ts
import { detectStorelySerialization } from '@ambicuity/core';
...
```ts
import { detectStorelyEncryption } from '@ambicuity/core';
...
```ts
import { detectCapabilities } from '@ambicuity/core';
...
```js
import { StorelyStats } from '@ambicuity/core';
