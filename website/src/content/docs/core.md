...
```ts
import { Storely, StorelyJsonSerializer } from "@ambicuity/ambicore";
...
```js
import Storely, { StorelyHooks } from '@ambicuity/ambicore';
```
...
Returns a `StorelyCapability` with a boolean for each Storely method/property. The `@ambicuity/ambicore` flag is `true` only when **all** capabilities are present.

```ts
import Storely, { detectStorely } from '@ambicuity/ambicore';
...
```ts
import { detectStorelyStorage } from '@ambicuity/ambicore';
...
```ts
import { detectStorelyCompression } from '@ambicuity/ambicore';
...
```ts
import { detectStorelySerialization } from '@ambicuity/ambicore';
...
```ts
import { detectStorelyEncryption } from '@ambicuity/ambicore';
...
```ts
import { detectCapabilities } from '@ambicuity/ambicore';
...
```js
import { StorelyStats } from '@ambicuity/ambicore';
