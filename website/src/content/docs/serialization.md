...
> **Note:** `@ambicuity/ambicore` is a peer dependency and must be installed alongside this package.
...
A class that implements the `StorelySerializationAdapter` interface from `@ambicuity/ambicore`.
